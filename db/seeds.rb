...
tag3 = Tag.create(event_id: event2.id, category_id: music.id)
tag4 = Tag.create(event_id: event2.id, category_id: show.id)
tag5 = Tag.create(event_id: event3.id, category_id: music.id)
tag6 = Tag.create(event_id: event3.id, category_id: show.id)
tag7 = Tag.create(event_id: event4.id, category_id: music.id)
tag8 = Tag.create(event_id: event4.id, category_id: show.id)
tag9 = Tag.create(event_id: event5.id, category_id: music.id)
tag10 = Tag.create(event_id: event5.id, category_id: show.id)
tag11 = Tag.create(event_id: event6.id, category_id: music.id)
tag12 = Tag.create(event_id: event6.id, category_id: show.id)
tag13 = Tag.create(event_id: event7.id, category_id: music.id)
tag14 = Tag.create(event_id: event7.id, category_id: show.id)
tag15 = Tag.create(event_id: event8.id, category_id: music.id)
tag16 = Tag.create(event_id: event8.id, category_id: show.id)
tag17 = Tag.create(event_id: event9.id, category_id: music.id)
tag18 = Tag.create(event_id: event9.id, category_id: show.id)
tag19 = Tag.create(event_id: event10.id, category_id: music.id)
tag20 = Tag.create(event_id: event10.id, category_id: show.id)
tag21 = Tag.create(event_id: event11.id, category_id: music.id)
tag22 = Tag.create(event_id: event11.id, category_id: show.id)
tag23 = Tag.create(event_id: event12.id, category_id: music.id)
tag24 = Tag.create(event_id: event12.id, category_id: show.id)
tag25 = Tag.create(event_id: event13.id, category_id: music.id)
tag26 = Tag.create(event_id: event13.id, category_id: show.id)
tag27 = Tag.create(event_id: event14.id, category_id: music.id)
